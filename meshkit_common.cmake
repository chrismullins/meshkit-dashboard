# Meshkit Common Dashboard Script (adapted from ITK)
#
...
#   dashboard_source_name     = Name of source directory (Meshkit)
#   dashboard_binary_name     = Name of binary directory (Meshkit-build)
...
set(dashboard_git_url "git://github.com/chrismullins/meshkit.git")
endif()
if(NOT DEFINED dashboard_git_branch)
  if("${dashboard_model}" STREQUAL "Nightly")
    set(dashboard_git_branch cmake-build-system)
  else()
    # Maybe at some point we'll want a "Nightly branch" and something else
    set(dashboard_git_branch cmake-build-system)
  endif()
endif()
...
if(NOT DEFINED CTEST_SOURCE_DIRECTORY)
  if(DEFINED dashboard_source_name)
    ...
    set(CTEST_SOURCE_DIRECTORY ${CTEST_DASHBOARD_ROOT}/Meshkit)
  endif()
endif()
...
")
  ...
  set(CTEST_DROP_LOCATION "/submit.php?project=MeshKit")
